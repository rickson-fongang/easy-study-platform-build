  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/auth/register.php", {
        ...
        body: JSON.stringify({ ...formData, user_type: "tutor" }),
      })
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-2">Register as a Tutor</p>
        </div>

        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Tutor Registration</CardTitle>
            <CardDescription>Fill in your details to create a tutor account</CardDescription>
          </CardHeader>
          <CardContent>
            {error && (
